...
export const content = {
  es: {
    ...
    calculatu: {
      badge: "LO NUEVO DE MULTIVERSA",
      title: "Mercado sin",
      titleGradient: "Estrés.",
      desc: "Tu Asistente de Mercado personal. Deja de pelear con la calculadora y empieza a usar tu voz con Savara AI.",
      ctaPrimary: "Comenzar Gratis",
      ctaSecondary: "Hablar con Savara",
      appHeader: "CalculaTú",
      appSub: "Billetera Inteligente",
      inputManual: "Manual",
      inputVoice: "Savara AI",
      list: [
        { name: 'Harina PAN', price: '$1.20' },
        { name: 'Queso Duro', price: '$3.50' },
        { name: 'Mantequilla', price: '$2.10' },
      ],
      totalLabel: "Total a Pagar",
      executeBtn: "Calcular Total",
  ...
  en: {
    ...
    calculatu: {
      badge: "NEW FROM MULTIVERSA",
      title: "Stress-free",
      titleGradient: "Market.",
      desc: "Your personal Market Assistant. Stop fighting with the calculator and start using your voice with Savara AI.",
      ctaPrimary: "Start Free",
      ctaSecondary: "Talk to Savara",
      appHeader: "CalculaTú",
      appSub: "Smart Wallet",
      inputManual: "Manual",
      inputVoice: "Savara AI",
      list: [
        { name: 'Corn Flour', price: '$1.20' },
        { name: 'Hard Cheese', price: '$3.50' },
        { name: 'Butter', price: '$2.10' },
      ],
      totalLabel: "Total to Pay",
      executeBtn: "Calculate Total",
      banner: "Sound familiar? Reduce purchase anxiety."
    },
    faq: {
